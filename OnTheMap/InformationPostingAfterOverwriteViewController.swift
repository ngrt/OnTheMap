//
//  InformationPostingAfterOverwriteViewController.swift
//  
//
//  Created by Nawfal on 04/08/2015.
//
//
...
class InformationPostingAfterOverwriteViewController: UIViewController, UITextFieldDelegate {
        ...
        geoCoder.geocodeAddressString(addressString, completionHandler:
            {(placemarks: [AnyObject]!, error: NSError!) in
                ...
                if error != nil {
                    ...
                    let alertController = UIAlertController(title: "Ooups", message: "Error in Geocoding", preferredStyle: UIAlertControllerStyle.Alert)
